...
{ //porta=1 portb=2,portc=3,portd=4
	...
	*/
	_softpwm_channels[0]=10;
	_softpwm_channels[1]=20;
	_softpwm_channels[2]=30;
	_softpwm_channels[3]=40;
	_softpwm_channels[4]=50;
	_softpwm_channels[5]=60;
	_softpwm_channels[6]=70;
	_softpwm_channels[7]=80;
	_softpwm_channels[8]=90;
	_softpwm_channels[9]=100;
	_softpwm_channels[10]=110;
	_softpwm_channels[11]=120;
}	
