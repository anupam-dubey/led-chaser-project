...
{ //porta=1 portb=2,portc=3,portd=4
	...
	*/
	_softpwm_channels[0]=1;
	_softpwm_channels[1]=5;
	_softpwm_channels[2]=5;
	_softpwm_channels[3]=10;
	_softpwm_channels[4]=10;
	_softpwm_channels[5]=60;
	_softpwm_channels[6]=60;
	_softpwm_channels[7]=80;
	_softpwm_channels[8]=80;
	_softpwm_channels[9]=99;
	_softpwm_channels[10]=99;
	_softpwm_channels[11]=1;
}	
