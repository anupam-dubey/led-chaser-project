 ...
 708  00cf c6530b        	ld	a,21259
 709  00d2 a4fc          	and	a,#252
 710  00d4 c7530b        	ld	21259,a
...
1424  01ca ca5303        	or	a,21251
1425  01cd c75303        	ld	21251,a
1427  01d0 2009          	jra	L565
1428  01d2               L365:
1429                     ; 382     TIM2->IER &= (uint8_t)(~TIM2_IT);
1431  01d2 7b01          	ld	a,(OFST+1,sp)
1432  01d4 43            	cpl	a
1433  01d5 c45303        	and	a,21251
1434  01d8 c75303        	ld	21251,a
1435  01db               L565:
1436                     ; 384 }
1439  01db 85            	popw	x
1440  01dc 81            	ret
...
1825  0211 c65307        	ld	a,21255
1826  0214 a48f          	and	a,#143
1827  0216 1a01          	or	a,(OFST+1,sp)
1828  0218 c75307        	ld	21255,a
1829                     ; 515 }
1832  021b 84            	pop	a
1833  021c 81            	ret
...
1881  021e c65308        	ld	a,21256
1882  0221 a48f          	and	a,#143
1883  0223 1a01          	or	a,(OFST+1,sp)
1884  0225 c75308        	ld	21256,a
1885                     ; 534 }
1888  0228 84            	pop	a
1889  0229 81            	ret
...
1937  022b c65309        	ld	a,21257
1938  022e a48f          	and	a,#143
1939  0230 1a01          	or	a,(OFST+1,sp)
1940  0232 c75309        	ld	21257,a
1941                     ; 553 }
1944  0235 84            	pop	a
1945  0236 81            	ret
...
2983  0341 c65307        	ld	a,21255
2984  0344 a4f3          	and	a,#243
2985  0346 1a01          	or	a,(OFST+1,sp)
2986  0348 c75307        	ld	21255,a
2987                     ; 928 }
2990  034b 84            	pop	a
2991  034c 81            	ret
...
3039  034e c65308        	ld	a,21256
3040  0351 a4f3          	and	a,#243
3041  0353 1a01          	or	a,(OFST+1,sp)
3042  0355 c75308        	ld	21256,a
3043                     ; 948 }
3046  0358 84            	pop	a
3047  0359 81            	ret
...
3095  035b c65309        	ld	a,21257
3096  035e a4f3          	and	a,#243
3097  0360 1a01          	or	a,(OFST+1,sp)
3098  0362 c75309        	ld	21257,a
3099                     ; 968 }
3102  0365 84            	pop	a
3103  0366 81            	ret
...
3734  0419 43            	cpl	a
3735  041a c75304        	ld	21252,a
3736                     ; 1110   TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
3738  041d 35ff5305      	mov	21253,#255
3739                     ; 1111 }
3742  0421 81            	ret
...
3970  044c 7211530a      	bres	21258,#0
...
3980  045b c65307        	ld	a,21255
3981  045e a40c          	and	a,#12
3982  0460 1a01          	or	a,(OFST+0,sp)
3983  0462 c75307        	ld	21255,a
...
4068  047c 7219530a      	bres	21258,#4
...
4078  048b c65308        	ld	a,21256
4079  048e a40c          	and	a,#12
4080  0490 1a01          	or	a,(OFST+0,sp)
4081  0492 c75308        	ld	21256,a
...
4166  04ac 7211530b      	bres	21259,#0
...
4176  04bb c65309        	ld	a,21257
4177  04be a40c          	and	a,#12
4178  04c0 1a01          	or	a,(OFST+0,sp)
4179  04c2 c75309        	ld	21257,a
